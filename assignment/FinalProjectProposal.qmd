...
#I have a data that was collected on climate change perception among households of low-income communities in Dar es Salaam, It contains sociodemographic informations, their perception of how climate change impact water security adaptive strategies. This data was gotten through questionnaires and have open ended questions, with binary, and norminal responses coded.

#The data needs to be cleaned as we dont have a 100% response rate. I could either remove missing values or fill them up.

#The task maybe just to clean it up , set up a directory for both the raw,cleans and output file path then do some visualizations tat is reproducible.

#I can plot the oercentage of respondents response and perceptions to some of the questions
